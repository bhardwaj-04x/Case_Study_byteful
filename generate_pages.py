...
.cs-pro .cs-hero::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(ellipse 60% 80% at 80% 50%, rgba(233,0,4,.12), transparent);
  pointer-events: none;
}
...
.cs-pro .cs-lead { font-size: 1.05rem; color: var(--mu); line-height: 1.85; }
...
.cs-pro .cs-chal-item p { font-size: 0.9rem; color: var(--mu); line-height: 1.65; }
...
.cs-pro .cs-band__title    { font-size: clamp(1.4rem, 3vw, 2rem); font-weight: 900; color: var(--wh); margin-bottom: 12px; }
.cs-pro .cs-band__sub      { font-size: 1rem; color: rgba(255,255,255,.5); max-width: 560px; margin: 0 auto 28px; line-height: 1.7; }
...
.cs-pro .cs-step__body p  { font-size: 0.9rem; color: var(--mu); line-height: 1.7; }
...
.cs-pro .cs-deliv-card p  { font-size: 0.9rem; color: var(--mu); line-height: 1.65; }
...
@media (max-width: 1023px) {
  ...
  .cs-pro .cs-hero        { padding: 80px 24px 72px; }
...
@media (max-width: 480px) {
  ...
  .cs-pro .cs-lead { font-size: 0.97rem; }
...
@media (max-width: 360px) {
  ...
  .cs-pro .cs-band__sub         { font-size: 0.9rem; }
  .cs-pro .cs-conclusion__text  { font-size: 0.95rem; }
  .cs-pro .cs-step__body p,
  .cs-pro .cs-chal-item p       { font-size: 0.86rem; }
...
for cs in case_studies:
    if cs['rating'] in ('review', 'publish'):
        label    = 'Published' if cs['rating'] == 'publish' else 'In Review'
